...
AF_FILE=${REF_FNAME_VAR}-${METHOD}-${SCALING}-monthly-q100-bias-vs-${OBS_DATASET}_AUS-15_CSIRO-BOM-ACCESS-CM2_historical_r4i1p1f1_BOM-BARPA-R_v1_day_${HIST_START}01-${HIST_END}12.nc
AF_PATH=${OUTPUT_REF_DIR}/${AF_FILE}

QQ_BASE=${REF_FNAME_VAR}_AUS-15_CSIRO-BOM-ACCESS-CM2_historical-${EXPERIMENT}_r4i1p1f1_BOM-BARPA-R_v1_day_${TARGET_START}01-${TARGET_END}12_${METHOD}-${SCALING}-monthly-q100-linear_${OBS_DATASET}-${HIST_START}0101-${HIST_END}1231
