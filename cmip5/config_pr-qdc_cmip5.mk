...
#
# Compare against: /g/data/wp00/data/QQ-CMIP5/CanESM2/pr/rcp85/2056-2085/pr_AUS_CanESM2_rcp85_r1i1p1_CSIRO-QQS-AGCD-1981-2010_day_wrt_1986-2005_2056-2085.nc
#
# /g/data/al33/replicas/CMIP5/combined/CCCma/CanESM2/rcp85/day/atmos/day/r1i1p1/v20120407/pr/pr_day_CanESM2_rcp85_r1i1p1_20060101-21001231.nc
#
# /g/data/al33/replicas/CMIP5/combined/CCCma/CanESM2/historical/day/atmos/day/r1i1p1/v20120410/pr/pr_day_CanESM2_historical_r1i1p1_19790101-20051231.nc
...
HIST_FILES_ORIG := $(sort $(wildcard /g/data/${NCI_LOC}/CMIP5/combined/*/${MODEL}/historical/day/atmos/day/${RUN}/${HIST_VERSION}/${HIST_VAR}/*1850*.nc))
