...
AF_FILE=${REF_VAR}-${METHOD}-${SCALING}-monthly-q100-ssr-adjustment-factors_${OBS_DATASET}_NPCP-20i_${GCM_NAME}_${EXPERIMENT}_${GCM_RUN}_${RCM_NAME}_${RCM_VERSION}_day_${HIST_START}01-${HIST_END}12.nc
AF_PATH=${OUTPUT_REF_DIR}/${AF_FILE}

QQ_BASE=${REF_VAR}_NPCP-20i_${GCM_NAME}_${EXPERIMENT}_${GCM_RUN}_${RCM_NAME}_${RCM_VERSION}_day_${TARGET_START}01-${TARGET_END}12_${METHOD}-${SCALING}-monthly-q100-${INTERP}-ssr-${OBS_DATASET}-${HIST_START}01-${HIST_END}12
