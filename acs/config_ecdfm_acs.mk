...
HIST_START=1984
HIST_END=2014
HIST_DATA := $(sort $(wildcard ${HIST_PATH}/*.nc))
#HIST_DATA := $(sort $(wildcard ${HIST_PATH}/*day_198[4,5,6,7,8,9]*.nc) $(wildcard ${HIST_PATH}/*day_199*.nc) $(wildcard ${HIST_PATH}/*day_2*.nc))
REF_START=1985
REF_END=2014
REF_DATA := $(wildcard /g/data/xv83/agcd-csiro/${REF_VAR}/daily/*_AGCD-CSIRO_r005_*_daily_space-chunked.zarr)
TARGET_START=2030
TARGET_END=2059
TARGET_DATA := $(sort $(wildcard ${TARGET_PATH}/*.nc))
