...
OUTDRS=australian-climate-service/test-data/CORDEX-CMIP6/bias-adjusted-output/AUS-05i/${RCM_INSTITUTION}/${GCM_NAME}/${TARGET_EXP}/${GCM_RUN}/${RCM_NAME}/${BIAS_ADJUSTMENT}/day/${TARGET_VAR}Adjust

OUTPUT_AF_DIR=/g/data/xv83/dbi599/${OUTDRS}
...
OUTPUT_QQ_DIR=/g/data/ia39/${OUTDRS}
...
OUTPUT_VALIDATION_DIR=/g/data/xv83/dbi599/${OUTDRS}
