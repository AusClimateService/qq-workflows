...
OUTPUT_AF_DIR=/g/data/xv83/dbi599/bennett-postdoc/test-data/CORDEX-CMIP6/bias-adjusted-output/${OUTPUT_GRID_LABEL}/${RCM_INSTITUTION}/${GCM_NAME}/${HIST_EXP}/${GCM_RUN}/${RCM_NAME}/${BIAS_ADJUSTMENT}/day/${TARGET_VAR}Adjust
...
OUTPUT_QQ_DIR=/g/data/xv83/dbi599/bennett-postdoc/test-data/CORDEX-CMIP6/bias-adjusted-output/${OUTPUT_GRID_LABEL}/${RCM_INSTITUTION}/${GCM_NAME}/${TARGET_EXP}/${GCM_RUN}/${RCM_NAME}/${BIAS_ADJUSTMENT}/day/${TARGET_VAR}Adjust
...
METADATA_OPTIONS=${TARGET_VAR} ${OBS_DATASET} ${TARGET_EXP} ${SCALING} ${HIST_START}-${HIST_END}
